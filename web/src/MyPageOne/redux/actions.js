...
export function addUser(dispatch, name) {
  ...
  myaxios
    .post("/demo/add?name=" + name + "&email=" + name + "@gmail.com", {})
    .then(function (response) {
      console.log(response);
...
export function removeUser(dispatch, id) {
  console.log("action.js - removeUser() called ");
  console.log("action.js - removeUser() called id: ", id);
